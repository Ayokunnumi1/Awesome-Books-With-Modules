...
# 📖 <a name="about-project">AWESOME BOOKS LIBRARY</a>

This repository contains the source codes for a book library. It showcases my skills and expertise in creating Objects with Classes, Sectioning with Modules and using Add Event Listeners. I used HTML, CSS and Javascript programming languages in the creation of this project.
...
- [Live Demo Link](https://ayokunnumi1.github.io/Awesome-Books-With-Modules/)
...
```sh
  cd my-folder
  git@github.com:Ayokunnumi1/Awesome-Books-With-ES6.git
```
...
I appreciate my coding partner for their corrections in creating this project.
